        ...
        <div className="flex flex-row w-full space-x-4">
          ...
          <div className="w-[40%] ">
            ...
            <ul className="list-disc border-2 text-left text-sm">
              ...
              <li>
                In the "<strong>App-Specific Password</strong>" field, go to the
                Google account manager for the same email. Ensure two-step
                authentication is enabled, search for "
                <strong>App Password</strong>," generate it, and copy and paste
                the password into this field.
              </li>
              <li>
                In the "<strong>Enter Subject</strong>" field, enter the subject
                of the email.
              </li>
              <li>
                {" "}
